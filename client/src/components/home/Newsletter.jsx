...
const Newsletter = () => {
  return (
    <section className="bg-orange-100 py-18 px-4 sm:px-6 lg:px-8 rounded-3xl mx-auto  shadow-xs mt-32 mb-20">
      <div className="max-w-2xl mx-auto text-center">
        <div className="size-16 bg-white rounded-xl flex items-center justify-center mx-auto mb-6 shadow">
          <MailIcon className="size-8 text-green-300" strokeWidth={1.5} />
        </div>
        ...
        >
          ...
          />
          <button className="px-8 py-3.5 bg-green-300 text-white font-semibold rounded-xl hover:bg-app-green-light transition-colors shadow-sm whitespace-nowrap active:scale-[0.98]">
            Subscribe
          </button>
        </form>
      </div>
